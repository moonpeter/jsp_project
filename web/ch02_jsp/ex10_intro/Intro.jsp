...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/ch02_jsp/ex10_test/intro.css" type="text/css">
    <script type="text/javascript" src="${pageContext.request.contextPath}/ch02_jsp/ex10_test/intro.js"></script>
</head>
<body>
